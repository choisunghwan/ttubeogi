...
export const s = {
  ...
  tabbar: {
    ...
    background: "rgba(250,248,243,.95)", backdropFilter: "blur(8px)", borderTop: `1px solid ${C.border}`,
  },
  tabBtn: {
    flex: 1, padding: "10px 0", border: "none", background: "transparent", fontSize: 13.5,
    fontWeight: 700, color: C.textMuted, cursor: "pointer", borderRadius: 10,
  ...
  eyebrow: { fontSize: 11, letterSpacing: 2.5, color: C.textMuted, fontWeight: 700 },
  ...
  statLabel: { fontSize: 11.5, color: C.textMuted, marginTop: 5, fontWeight: 600 },
  ...
  detailHead: { display: "flex", justifyContent: "space-between", alignItems: "baseline",
                marginBottom: 12, paddingBottom: 12, borderBottom: `1px solid ${C.divider}` },
  ...
  detailKey: { color: C.textMuted, fontWeight: 600 },
  hint: { display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "18px 16px",
          color: C.textMuted, fontSize: 13.5, background: "#fff", borderRadius: 14, border: `1px dashed ${C.border}`, marginBottom: 14 },
  ...
  tripCostLabel: { fontSize: 13.5, fontWeight: 800, color: C.orangeDeep, marginTop: 4 },
  dayCostLabel: { fontSize: 12.5, fontWeight: 700, color: C.textMuted, marginBottom: 8 },
  ...
  planSpots: { fontSize: 11.5, color: C.textMuted, fontWeight: 600 },
  ...
  ticketBarcode: { width: "100%", height: 16, marginTop: 2,
                   ...
                   opacity: 0.6 },
  // 커뮤니티 카드 — ticketStub 자리에 D-day/GO 대신 좋아요 버튼 + "담기" 버튼을 넣는다.
  communityLikeBtn: { display: "flex", flexDirection: "column", alignItems: "center", gap: 2,
                       border: "none", background: "transparent", cursor: "pointer", padding: 0 },
  communityLikeCount: { fontSize: 11, fontWeight: 800, color: C.textMuted },
  communityImportBtn: { marginTop: 4, padding: "6px 10px", borderRadius: 20, border: "none",
                         background: C.orange, color: "#fff", fontSize: 11.5, fontWeight: 800, cursor: "pointer",
                         whiteSpace: "nowrap" },
  ...
  newHint: { textAlign: "center", fontSize: 12, color: C.textMuted, marginTop: 8 },
  ...
  backBtn: { border: "none", background: "transparent", color: C.textMuted, fontSize: 14, fontWeight: 700,
  ...
  themeSwatchLabel: { fontSize: 11.5, fontWeight: 700, color: C.textMuted },
  ...
  formHint: { fontSize: 12, color: C.textMuted, marginTop: 6 },
  ...
  geoCandidateAddr: { fontSize: 11.5, color: C.textMuted, marginTop: 2 },
  // 항목 첨부파일(항공권/기차표/바우처) 선택·미리보기
  attachmentPickBtn: { display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 14px",
                        borderRadius: 12, border: `1.5px dashed ${C.borderStrong}`, color: C.textMuted, fontSize: 13.5,
  ...
  // 빈 상태
  emptyState: { textAlign: "center", padding: "40px 16px", color: C.textMuted, fontSize: 14 },

  // 공유 링크 바
  shareHint: { fontSize: 12.5, color: C.orangeDeep, fontWeight: 700, marginBottom: 6 },
  shareBar: { display: "flex", alignItems: "center", gap: 8, background: "#fff", border: `1px dashed ${C.border}`,
              borderRadius: 12, padding: "10px 12px", marginBottom: 14 },
  shareLink: { flex: 1, minWidth: 0, fontSize: 12.5, color: C.textMuted, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" },
  ...
  adminTd: { padding: "9px 10px", borderBottom: `1px solid ${C.divider}`, whiteSpace: "nowrap", color: C.ink },
  ...
  dragHandle: { border: "none", background: "transparent", color: C.textMuted, fontSize: 18, lineHeight: 1,
  ...
  ticketEditLink: { border: "none", background: "transparent", color: C.textMuted, fontWeight: 700, fontSize: 12.5,
  ...
  flightTicketNoSub: { fontWeight: 600, color: C.textMuted },
  ...
  flightRouteCode: { fontFamily: SERIF_EN, fontSize: 21, fontWeight: 700, color: C.ink, letterSpacing: 0.3,
                      whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" },
  flightRouteMeta: { fontSize: 11.5, color: C.textMuted, fontWeight: 600, marginTop: 3, whiteSpace: "nowrap",
  ...
  modalCloseBtn: { border: "none", background: "transparent", fontSize: 20, color: C.textMuted, cursor: "pointer" },
  ...
  calSelectedLabel: { fontSize: 11.5, fontWeight: 700, color: C.textMuted, marginBottom: 6, letterSpacing: 0.2 },
