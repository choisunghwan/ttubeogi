...
export const s = {
  ...
  ticketWhen: { fontSize: 12, color: "#8a8170", marginBottom: 10, letterSpacing: 0.2 },
  ...
  adminTableWrap: { overflowX: "auto", border: "1px solid #efe9dc", borderRadius: 12, marginBottom: 8, background: "#fff" },
  adminTable: { width: "100%", borderCollapse: "collapse", fontSize: 13 },
  adminTh: { textAlign: "left", padding: "9px 10px", background: "#f7f2e6", color: "#6f6656", fontWeight: 700,
             fontSize: 11.5, whiteSpace: "nowrap", borderBottom: "1px solid #efe9dc" },
  ...
  flightTicketStatus: { fontSize: 11.5, fontWeight: 800, color: C.goldDeep, background: "#fbecd9",
